...
namespace tc
{
    ...
    MainWindowWrapper::MainWindowWrapper(const std::shared_ptr<MessageNotifier>& notifier, QMainWindow* window) : QObject(window) {
        notifier_ = notifier;
        window_ = window;
    }
    ...
    MainWindowWrapper* MainWindowWrapper::ShowProfile(bool show) {
        show_profile_ = show;
        return this;
    }

    MainWindowWrapper* MainWindowWrapper::ShowSettings(bool show) {
        show_settings_ = show;
        return this;
    }

    MainWindowWrapper* MainWindowWrapper::ShowPinTop(bool show) {
        show_pin_top_ = show;
        return this;
    }

    MainWindowWrapper* MainWindowWrapper::ShowMin(bool show) {
        show_min_ = show;
        return this;
    }

    MainWindowWrapper* MainWindowWrapper::ShowMax(bool show) {
        show_max_ = show;
        return this;
    }

    MainWindowWrapper* MainWindowWrapper::ShowClose(bool show) {
        show_close_ = show;
        return this;
    }
